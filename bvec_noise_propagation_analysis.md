...
![Bias by axon radius bin](fig_bvec_bias_bar_v2.png)
...
| Protocol | r (um) | Baseline | Uncorrected | Corrected |
|----------|:---:|:---:|:---:|:---:|
| C2 | 0-1 | +1.736 | +1.717 | +1.711 |
| C2 | 1-2 | +0.815 | +0.803 | +0.792 |
| C2 | 2-3 | +0.071 | +0.079 | +0.066 |
| C2 | 3-4 | -0.208 | -0.183 | -0.202 |
| C2 | 4-5 | -0.383 | -0.363 | -0.396 |
| C1 | 0-1 | +2.209 | +2.194 | +2.201 |
| C1 | 1-2 | +1.266 | +1.268 | +1.264 |
| C1 | 2-3 | +0.459 | +0.469 | +0.454 |
| C1 | 3-4 | -0.227 | -0.239 | -0.242 |
| C1 | 4-5 | -0.755 | -0.755 | -0.761 |
