# Gradient Nonlinearity Correction - b_scale computation for AxCaliber-SMT
# Reference: QT (Qiuyun Fan) email, WashU HCP pipeline

# Step 1. Compute GNC warp field using Qiuyun's script (C2 scanner)
...
# Step 2. Compute grad_dev (3x3 gradient deviation tensor per voxel) from the relative warp field
